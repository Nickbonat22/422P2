...
class MainViewController():
    ...
    def __init__(self):
        ...
        self.flashcard_tab_view = self.mainView.get_flashcard_tab_view()

        # # Bind button/keystrokes to Cold Caller Service APIs
        self.flashcard_tab_view.createWidgets_bottom_Frame()
