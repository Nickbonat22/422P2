...
class FlashcardTabView(Frame):
    def __init__(self, master):
        ...
        self.portrait = None
        self.good_btn = None
        self.concern_btn = None

    def _make_portrait_with_name_label(self, parent, name, portrait_path):
    ...
    def createWidgets_bottom_Frame(self):
        ...
        btn_frame.grid(row=2, column=1, sticky=(N,S,E,W))
        
        self.good_btn = Button(btn_frame, text="Remove")
        self.concern_btn = Button(btn_frame, text="Concern")
        self.good_btn.grid(row=0, column=0, sticky=(N,S,E,W))
        self.concern_btn.grid(row=0, column=1, sticky=(N,S,E,W))